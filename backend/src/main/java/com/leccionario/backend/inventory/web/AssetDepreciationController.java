...
@CrossOrigin(origins = "*")
@Tag(name = "Depreciación y Garantías")
public class AssetDepreciationController {
    ...
    @Operation(summary = "Obtener depreciación de un activo")
    ...
    @Operation(summary = "Listar garantías vigentes")
    ...
    @Operation(summary = "Listar garantías próximas a vencer")
    ...
    @Operation(summary = "Actualizar una garantía")
